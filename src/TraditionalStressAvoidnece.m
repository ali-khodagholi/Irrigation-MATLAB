...
grid on;
title('Actual ET - Traditional: Stress Avoidance');
xlabel('Time (Day)');
...
title('Soil Moisture - Traditional: Stress Avoidance');
grid on;
hold on;
xlabel('Time (Day)');
...
title('Irrigation - Traditional: Stress Avoidance');
grid on;
xlabel('Time (Day)');
